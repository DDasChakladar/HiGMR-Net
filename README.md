...
By integrating global brain-network organization with local temporal connectivity changes, HiGMR-Net provides a robust and interpretable representation of disorder-related neural dynamics, supporting more reliable EEG-based FTD classification.
